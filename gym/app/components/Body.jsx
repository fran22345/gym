...
function Body() {
  return (
    <section>
      <div class="px-0 py-12 mx-auto md:px-12 lg:px-24 max-w-7xl">
        <div class="flex flex-row grow gap-12 mx-auto lg:grid-cols-3">
          <div class="p-6">
            <div class="inline-flex items-center justify-center w-12 h-12 mx-auto mb-5 text-blue-600 rounded-full bg-blue-50">
              <svg
